...
function AnswerRow(props) {
  return(
    <tr><AnswerData answer={props.answer}/><AnswerActions answerId={props.answer.id} voteUp={props.voteUp}/></tr>
  );
}
...
function AnswerActions(props) {
  return <td>
    <Button variant='success'><i className='bi bi-plus' onClick={() => props.voteUp(props.answerId)}></i></Button>
    </td>
}
